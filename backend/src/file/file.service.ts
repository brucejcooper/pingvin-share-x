...
export interface File {
  ...
  // Set when the client's `Range` header could not be satisfied (e.g. a start
  // beyond the end of the file). The controller responds `416`. `size` carries
  // the total file size for the `Content-Range: bytes */<size>` header.
